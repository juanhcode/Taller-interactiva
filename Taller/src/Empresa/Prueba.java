...
public class Prueba {
    ...
    public static void salarioAumentadoSecretario(int anio_transcurrido) {
        ...
        Secretario secretario = new Secretario("E", "Benjumea", "1006490", "Calle 21", "313812312", 5000); //Objetos con datos Personales
        secretario.incrementarSalario(calcularSalario(0.05, anio_transcurrido, secretario.getSalario())); //Incrementa salario
